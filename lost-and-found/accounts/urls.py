...
from .views import SignupView, LoginView, logout_view, ProfileView, MyPostView, ChangePasswordView, EditProfileView, rewards_view, close_post
urlpatterns = [
    ...
    path("close_post/", close_post, name="close_post"),
